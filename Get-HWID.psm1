...
$(Write-Host "======================================================================")
$( 
Write-Host ("BIOS UUID:        `t`t`t" + $system.UUID)
Write-Host ("BIOS Serial:      `t`t`t" + $bios.SerialNumber)
Write-Host ("Baseboard Serial: `t`t`t" + $baseboard.SerialNumber)
Write-Host "Baseboard Asset Tag:`t`tDefault string"
Write-Host "Enclosure Serial:   `t`tDefault string"
Write-Host "Enclosure Asset Tag:`t`tDefault string"
)
$(Write-Host " ")    
